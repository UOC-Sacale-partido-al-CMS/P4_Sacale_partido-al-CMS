...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20181220_jdarunning_bd_51628916f38fabb54604_20181220163757_archive.zip';
	const ARCHIVE_SIZE		 = '203641';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '5162891-20163757';
	const VERSION			 = '1.3.0';
